...
namespace _2019LD601_PRACTICA0204.Controllers
{
    public class ColoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_colores,color,estado")] Colore colore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_colores,color,estado")] Colore colore)
        {
            if (ModelState.IsValid)
            {
